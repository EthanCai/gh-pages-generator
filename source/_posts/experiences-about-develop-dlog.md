...
本文记录了前段时间我和[王益](https://segmentfault.com/a/1190000002416822)使用Go语言合作开发一个log组件[dlog](https://github.com/topicai/dlog)的过程中学到的一些知识。在整个合作开发的过程中，王益严谨认真的态度，对开发质量的严格要求，给我留下了及其深刻的印象。能够和王益这样的顶级工程师切磋技艺，对我学习Go语言帮助非常大。也谨以此文表达对王益的感谢。
